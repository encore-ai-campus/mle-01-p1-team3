...
**김동석** : 인벤(INVEN) 게시판(2,970여개)을 크롤링했고, 수집된 데이터를 정제 | 청킹 | 벡터DB구축하고, RAG chain 구현과 평가셋 까지 짧은 기간 정신 없이 달려 왔지만, 운 좋게 실력 있는 팀원 두분을 만나 일정에 맞춰 성공적인 프로젝트 마무리를 할 수 있었습니다. 이번 프로젝트를 통해 경험한 기술을 온전히 제 것으로 만들기 위한 새로운 RAG 기반 시스템 구축을 구상해 볼 계획입니다.
**이승재** :
